...
//FAKE QUOTED
const fgclink = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@g.us"},"message": {"groupInviteMessage": {"groupJid": "6287772549185-1622678501@g.us","inviteCode": "https://chat.whatsapp.com/BvwLZPkx6rm26ZGzNtPApi","groupName": "Group Official", "caption": `${footer}`, 'jpegThumbnail': ('./media/zaki.jpg')}}}
...
if (q.includes('--help')) return reply(examkosong) 
  ...
  if (!isInventoriBuruan){ addInventoriBuruan(m.sender) }
     ...
     await zaki.send5ButImg(from, `` + '' + teksehmazeh, `© ${footer}`, flob, [{"urlButton": {"displayText": "Join Group OFC","url": `${sc}`}}])
  }
  break
        case 'limituser':
{      
        ...
        if (stderr.trim()) reply(stderr)
            ...
            break
                    case 'bug': case 'report': {
                    	...
                    	zaki.sendMessage(`6282252285143@s.whatsapp.net`, {text: `*Bug Report From:* wa.me/${m.sender.split("@")[0]}
Report Message: ${text}` })
...
`
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({ templateMessage: { hydratedTemplate: { hydratedContentText: txt.trim(), locationMessage: { jpegThumbnail: fs.readFileSync('./media/menu.jpg') }, hydratedFooterText: `${footer1}`, hydratedButtons: [{ urlButton: { displayText: 'Group Official', url: 'https://chat.whatsapp.com/BvwLZPkx6rm26ZGzNtPApi'} }, { quickReplyButton: { displayText: 'Owner', id: 'owner', } }, { quickReplyButton: { displayText: 'Donate', id: 'donate', } }, { quickReplyButton: { displayText: 'List Menu', id: 'allmenu', } }] } } }), { userJid: m.sender, quoted: m }); //conn.reply(m.chat, text.trim(), m) 
  zaki.relayMessage( m.chat, template.message, { messageId: template.key.id } )
break
case 'command': case 'allmenu': case 'listmenu': {
var butonnya =
[{ urlButton: { displayText: 'Group Official', url: 'https://chat.whatsapp.com/BvwLZPkx6rm26ZGzNtPApi'} }, 
...
//━━━━━━━━━━━━━━━[ MENU LOC ]━━━━━━━━━━━━━━━\\
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({ templateMessage: { hydratedTemplate: { hydratedContentText: `${ccomannya}`, locationMessage: { jpegThumbnail: fs.readFileSync('./media/allmenu.jpg') }, hydratedFooterText: `${footer}`, hydratedButtons: [{ urlButton: { displayText: 'Group Official', url: 'https://chat.whatsapp.com/BvwLZPkx6rm26ZGzNtPApi'} }] } } }), { userJid: m.sender, quoted: m }); //conn.reply(m.chat, text.trim(), m) 
  zaki.relayMessage( m.chat, template.message, { messageId: template.key.id } )
...
break
case 'ssweb': {
if (!args[0]) return reply(`Example : \n${prefix + command} https://instagram.com/ryannn.store`)
